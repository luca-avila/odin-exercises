export function createContact() {
    ...
    description.textContent = 'Ready to elevate your event with professional drink catering? Contact us today for a personalized quote.';
    ...
    locationText.innerHTML = '<strong>Service Area</strong><br>Greater Metro Area';
    ...
    ctaDescription.textContent = 'Get a free quote for your next event. We respond within 24 hours.';
